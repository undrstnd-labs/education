          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto grid max-w-md grid-cols-1 gap-8 lg:max-w-4xl lg:grid-cols-2">
              {tiers.map((tier) => (
                ...
                >
                  ...
                  <Link href={tier.href} aria-describedby={tier.id}>
                    <Button className="items-center mt-8 w-full bg-cyan-600 hover:bg-cyan-500 font-semibold">
                      Get started today
                    </Button>
                  </Link>
                </div>
              ...
              <div className="flex flex-col items-start gap-x-8 gap-y-6 rounded-3xl p-8 ring-1 ring-gray-900/10 sm:gap-y-10 sm:p-10 lg:col-span-2 lg:flex-row lg:items-center">
                ...
                <Link href="/education">
                  <Button
                    className="font-semibold leading-6 text-cyan-600 hover:text-cyan-700 ring-1 ring-inset ring-cyan-200 hover:ring-cyan-300"
                    variant={"outline"}
                  >
