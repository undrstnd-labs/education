...
\begin{longtable}{|p{4cm}|p{11cm}|}
    ...
    \hline
    \centering \textbf{Prisma} \vspace{0.2cm} \newline \centering \includegraphics[width=1.5cm,height=1.5cm]{chp5/prisma.png} & Prisma est un \textbf{ORM} (\textbf{O}bject-\textbf{R}elational \textbf{M}apping) qui facilite l'interaction avec la base de données en utilisant un langage de requête TypeScript sécurisé. \\
    \hline
...
\begin{figure}[H]
    ...
    \caption{Indice de qualité des différents modèles de langage naturel}
...
\begin{figure}[H]
    ...
    \caption{Débit en tokens par seconde des différents modèles de langage naturel}
