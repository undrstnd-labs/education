...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{images/chp4/fig2.png}
...
\section{Conception de la vue statique: Diagramme de classes}
...
\section{Conception de la vue dynamique}
...
\subsection{Diagramme de séquence de conception}
\justifying
...
\begin{itemize}[itemsep=1pt, parsep=1pt]
    \item \textbf{Diagramme de séquence de conception « S’identifier » }\\
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=1.5\textwidth,height=1.2\textwidth,angle=90]{images/chp4/fig7.png}
    ...
    \item \textbf{Diagramme de séquence de conception « Créer classroom » }\\
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=1.25\textwidth,height=1.2\textwidth,angle=90]{images/chp4/fig8.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=1.25\textwidth,height=1.2\textwidth,angle=90]{images/chp4/fig9.png}
...
\subsection{Diagramme d’activité « Modifier profil »}
\justifying
...
\subsection{Diagramme d’états-transitions « Archiver classroom »}
\justifying
...
La Figure 4.11 illustre le diagramme d’états-transitions du cas d’utilisation \textbf{<<Archiver classroom>>} pour l’état du classroom qui peut être dans l’état \textbf{<<désarchivé>>} ou l’état \textbf{<<archivé>>}.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{images/chp4/fig11.png}
    \caption{Diagramme d’activité « Modifier Profil »}
    \label{fig:Diagramme d’états-transitions « Archiver classroom »}    
\end{figure}
