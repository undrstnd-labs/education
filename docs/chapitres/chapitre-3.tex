...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.2\textwidth,height=0.4\textheight]{images/chp3/fig1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.2\textwidth,height=0.65\textheight]{images/chp3/fig2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\textwidth,height=0.8\textheight]{images/chp3/fig3.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\textwidth,height=0.8\textheight]{images/chp3/fig4.png}
...
\begin{itemize}[itemsep=1pt, parsep=1pt]
    ...
    \item \textbf{Diagramme de séquence acteur-système}\\
     ...
     La Figure 3.6 illustre le diagramme de séquence \textbf{<< S’identifier >>}.
     \begin{figure}[H]
        \centering
...
\begin{itemize}[itemsep=1pt, parsep=1pt]
    ...
    \begin{figure}[H]
        ...
        \caption{Les statistiques de la satisfaction des utilisateurs à l’usage des frameworks et bibliothèques dans le domaine du développement web}[6]        
...
\begin{itemize}[itemsep=1pt, parsep=1pt]
    ...
    \begin{figure}[H]
        ...
        \caption{Les statistiques des options de base de données les plus populaires}[7]        
